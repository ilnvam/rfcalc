...
class EIRPFrame(customtkinter.CTkFrame):
    ...
    def __init__(self, parent, title):
        ...
        self.textbox.grid(row=1, column=0, padx=12, pady=(10, 0), sticky="w", columnspan=3)
        self.textbox.insert(
            "0.0",
        ...
        # Result Label
        self.result_label = customtkinter.CTkLabel(self,
                                               text="...",
        ...
        self.to_option = customtkinter.CTkOptionMenu(
            self,
            values=[name.value for name in EIRP],
            command=self._to_option_onchange
        )
    ...
    def update_result(self, *args):
        try:
            ...
            result = self.conv.convert(value,
                                       self.from_enum_var,
                                       self.to_enum_var,
